...
use common\modules\blogs\models\backend\Blog;
use common\modules\blogs\models\backend\BlogSearch;
...
class DefaultController extends Controller
{
     ...
     *
     * @return \common\modules\blogs\models\backend\Blog Model
     *
    ...
    {
        if (is_array($id)) {
            /** @var \common\modules\blogs\models\backend\Blog $model */
