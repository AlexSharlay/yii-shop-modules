...
<div class="catalog-content js-scrolling-area">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb breadcrumb_upd">
            ...
            <?php if (!empty($categoryUrl['title4'])): ?>
                <li><a href="<?= $categoryUrl['url4'] ?>"><?= $categoryUrl['title4'] ?></a></li>
            <?php endif; ?>
        ...
        <div class="side_info_boo">
            <aside class="brand_list_warp">
                ...
                <div class="head_rubric">
                    <span class="rubric sec_akcent alpha display-block smb" style="padding:5px;text-align:center;font-size:18px;"><i></i>Подобрать</span>
                </div>
...
<!--            <p class="amount"><span style="color:#326D8B;font-weight:bold;">--><?//= $categoryProducts['total'] ?><!--</span>--><?//= numberof($categoryProducts['total'], 'товар', array('', 'а', 'ов')) ?><!--</p>-->
                                    ...
                                    <div id="div_<?= $product['id'] ?>" style="height:200px;width:223px;position:relative;margin:0 auto;">
                                      ...
                                      <div class="product_info">
                                        ...
                                        <p class="product_manufact">
                                            <img src="<?= $product['ico_country'] ?>" alt="">
                                            <a href="/manufacturer/<?= $product['alias_manufacturer'] ?>/"><?= $product['title_manufacturer'] ?></a>
...
<!--                                                        <a href="<?/*= \yii\helpers\Url::to(['/shop/cart/add', 'id' => $product['id']]) */?>"
                                                        ...
                                                        <button type="button" class="add-to-cart cart_smb btn smb"
                                                            ...
                                                            <? } else { ?>
                                                                ...
                                                                onclick="vmCart.addProductFromCategory(<?=$product['id']?>)"
                                                            <? } ?>
                                                        >В корзину
                                                        </button>
                                                        <input type="hidden" min="1" name="number" value="1" id="count-<?=$product['id']?>">
