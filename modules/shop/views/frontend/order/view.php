...
<div class="shop-order-view">
    ...
    <p>
        <?= Html::a('Вернуться к списку заказов', '/my/orders/', ['class' => 'btn btn-default']) ?>
    </p>
    ...
    <table class="table table-striped table-bordered detail-view">
        ...
        <tr>
            ...
            <td>
                ...
                if ($status['title'] == 'Внимание! Не весь товар на складе.') $dop = ' Свяжитесь с менеджером.';
                echo '<span class="label ' . $status['class'] . '">' . $status['title'] . $dop . '</span>';
    ...
    <?php if ($status['title'] == 'Согласован с менеджером.'): ?>
        <?= Html::beginForm(['/my/orders/'], 'POST') ?>
        <?php echo '<br />' . Html::submitButton('Я согласен оплатить данный заказ', ['class' => 'btn btn-warning', 'name' => 'order', 'value' => $model->id]);?>
        <?= Html::endForm(); ?>
    <?php endif; ?>
