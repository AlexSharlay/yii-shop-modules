...
namespace common\modules\comments\controllers\frontend;

use common\modules\comments\models\frontend\Comment;
...
class DefaultController extends Controller
{
    ...
    protected function tree($model)
    {
        ...
        return $this->renderPartial('@common/modules/comments/widgets/views/_index_item', ['models' => $models]);
    }
}
