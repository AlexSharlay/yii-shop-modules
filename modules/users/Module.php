...
class Module extends \yii\base\Module
{
     ...
     */
    public $robotEmail = 'no-reply@shop.by';
     ...
     */
    public $adminRoles = ['admin', 'contentManager'];
    ...
    public function init()
    {
        ...
        if ($this->isBackend === true) {
            $this->setViewPath('@common/modules/users/views/backend');
        } else {
            $this->setViewPath('@common/modules/users/views/frontend');
        }
    }
