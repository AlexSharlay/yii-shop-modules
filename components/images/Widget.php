 ...
 *
 * @author Natalevich Denis <Denis Natalevich@gmail.com>
 *
 */
class Widget extends BaseWidget
{
    /** Name of inline JavaScript package that is registered by the widget */
    const INLINE_JS_KEY = 'common/components/images/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['common/widget/imperavi']) && !isset(Yii::$app->i18n->translations['common/widget/imperavi/*'])) {
            Yii::$app->i18n->translations['common/widget/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@common/widget/imperavi/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'common/widget/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
