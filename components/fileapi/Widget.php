 ...
 * ```
 * ...
 * echo \common\components\fileapi\Widget::widget([
 *     'name' => 'fileapi',
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 ...
 * ```
 * ...
 * echo $form->field($model, 'file')->widget('common\components\fileapi\Widget', [
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 * ]);
...
class Widget extends InputWidget
{
    ...
    {
        return Yii::t('common/components/' . $category, $message, $params, $language);
    }
    ...
    {
        if (!isset(Yii::$app->i18n->translations['common/components/fileapi']) && !isset(Yii::$app->i18n->translations['common/components/*'])) {
            Yii::$app->i18n->translations['common/components/fileapi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@common/components/fileapi/messages',
                'fileMap' => [
                    'common/components/fileapi' => 'fileapi.php'
                ],
